    ...
    public partial class Nomina : Form
    {
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                CalculandoOtros obj3 = new CalculandoOtros(salBas);
                ...
                double[] vector = { salBas, horas, antiduedad, salBru, inss1, obj2.calculandoIr(cmbFecha.Text), cuota, AntS, deducciones, salNeto, obj3.CalculandoInatec(), obj3.CalculandoInssPatronal(), obj3.CalculandoVacacciones(), obj3.CalculandoVacacciones(), obj3.CalculandoVacacciones() };
                ...
                if (n != 1)
                {
                    ...
                    ArchivoNomina.WriteLine("Nombre del Empleado        |Salario Basico     |Horas Extras       |Antigüedad     |Salario Bruto      |INSS Laboral       |IR     |Cuota Sindical     |Anticipo de Salario        |Total Deducciones      |Salario Neto       |INATEC     |INSS Patronal      |Vacacione      |Aguinaldo      |Indemnización    |");
                }
